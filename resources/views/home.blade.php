...
@section('content')
    <div class="px-4 pt-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">
                Buy and sell any tokenised asset through this platform. There is no fees imposed by the platform!
            </p>
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                <a href="/dashboard"><button type="button" class="btn btn-primary px-4 me-sm-3">Dashboard</button></a>
                {{-- <a href="/faq"><button type="button" class="btn btn-warning px-4 me-sm-3">Learn More</button></a> --}}
            </div>
        </div>
